...
_hammerhead_api_dir = pathlib.Path("Hammerhead API")
_hammerhead_last_activity_date_path = _cache_dir / "hammerhead-last-activity-date.json"
...
hammerhead_api_dir = dir_wrapper(_hammerhead_api_dir)
...
hammerhead_last_activity_date_path = file_wrapper(_hammerhead_last_activity_date_path)
